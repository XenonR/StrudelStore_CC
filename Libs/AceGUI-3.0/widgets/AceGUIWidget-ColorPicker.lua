...
local INVERTED_ALPHA = (WOW_PROJECT_ID and WOW_PROJECT_ID ~= WOW_PROJECT_MAINLINE) or (not WOW_PROJECT_ID and interfaceVersion < 100000)
...
local function Constructor()
	...
	SetColorTextureCompat(texture, 1, 1, 1)
