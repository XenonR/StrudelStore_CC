...
local function safecall(func, ...)
	if func then
		...
		elseif argc == 1 then
			local a1 = ...
			return xpcall(function() return func(a1) end, errorhandler)
		elseif argc == 2 then
			local a1, a2 = ...
			return xpcall(function() return func(a1, a2) end, errorhandler)
		elseif argc == 3 then
			local a1, a2, a3 = ...
			return xpcall(function() return func(a1, a2, a3) end, errorhandler)
		elseif argc == 4 then
			local a1, a2, a3, a4 = ...
			return xpcall(function() return func(a1, a2, a3, a4) end, errorhandler)
		else
			local a1, a2, a3, a4, a5 = ...
			return xpcall(function() return func(a1, a2, a3, a4, a5) end, errorhandler)
		end
	end
end
...
do
	...
	if not frame or oldminor < 81 then
		...
		local border = CreateFrame("Frame", nil, frame, {type = "Frame", inherits = "DialogBorderNoCenterTemplate"})
