...
local function SetColorTextureCompat(texture, r, g, b, a)
...
local function Constructor()
	...
	local treeframe = CreateFrame("Frame", nil, frame, {type = "Frame", mixin = "BackdropTemplateMixin"})
	...
	local dragger = CreateFrame("Frame", nil, treeframe, {type = "Frame", mixin = "BackdropTemplateMixin"})
	dragger:SetWidth(8)
	...
	SetColorTextureCompat(scrollbg, 0, 0, 0, 0.4)

	local border = CreateFrame("Frame", nil, frame, {type = "Frame", mixin = "BackdropTemplateMixin"})
