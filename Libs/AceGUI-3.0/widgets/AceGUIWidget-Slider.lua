...
local function Constructor()
	...
	local slider = CreateFrame("Slider", nil, frame, {type = "Frame", mixin = "BackdropTemplateMixin"})
	...
	local editbox = CreateFrame("EditBox", nil, frame, {type = "Frame", mixin = "BackdropTemplateMixin"})
